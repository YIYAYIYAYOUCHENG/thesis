...
does nothing and occupy the CPU when no rt or normal tasks need a CPU.
...
To differentiate, here we call them cfs (scheduling) entity and
rt (scheduling) entity respectively.
\begin{lstlisting}[language=C, 
...
through methods like \texttt{sched\_setscheduler}.
