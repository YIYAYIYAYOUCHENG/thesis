...
set xlabel 'Per CPU bandwidth allocated(s/s)'
#plot 'expB1.dat' using 2:xticlabels(1) ti col, '' u 3 ti col
set style line 1 lc rgb '#0060ad' lt 1 lw 2 pt 7 ps 1.5   # --- blue
set style line 2 lc rgb '#dd181f' lt 1 lw 2 pt 5 ps 1.5   # --- red
set style data linespoints	
set key autotitle columnhead
#plot 'expB1.dat' using 4:2:xticlabels(1) ls 1 ti col, '' using 4:3 ls 2 ti col
plot 'expB1.dat' using 2:xticlabels(1) ls 1, '' using 3 ls 2
